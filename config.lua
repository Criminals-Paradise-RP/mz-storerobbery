...
Config.NotifyType = 'qb'                      -- Notification type (set to 'qb' to use qb-core standard notifications.)
...
Config.MinimumStoreRobberyPolice = 1            -- Minimum police that need to be on duty before a store can be robbed.
...
Config.SafeReqItem = "lockpick"                     -- Change to any item you want (needs to be in qb-core/shared/items.lua)
...
Config.LiquorReqItem = "lockpick"              -- Item needed to attempt to breach a liquor safe.
